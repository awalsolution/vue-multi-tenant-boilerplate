...
const preset: any = ref(layoutConfig.preset);
const presetOptions: any = ref(Object.keys(presets));

const menuMode: any = ref(layoutConfig.menuMode);
const menuModeOptions: any = ref([
  { label: 'Static', value: 'static' },
  { label: 'Overlay', value: 'overlay' }
]);

const primaryColors: any = ref([
  { name: 'noir', palette: {} },
  {
    name: 'emerald',
    palette: {
...
function getPresetExt() {
  const color: any = primaryColors.value.find((c: any) => c.name === layoutConfig.primary);
