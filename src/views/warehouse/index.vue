      ...
      <div class="flex flex-col items-center space-y-2 sm:flex-row sm:justify-between sm:space-y-0">
        <div class="flex flex-col items-center space-y-2 sm:flex-row sm:space-x-3 sm:space-y-0">
          <div class="flex flex-col sm:flex-row w-full items-center !space-x-2 sm:w-fit">
            <n-input
              class="sm:!w-[230px]"
              v-model:value="searchParams.warehouse_name"
              clearable
        ...
        <div class="flex w-full items-center justify-between space-x-3 sm:justify-end">
          <NButton
            ...
            v-permission="{ action: ['can view warehouse create'] }"
          >
            Create
          </NButton>
        </div>
        ...
        <thead class="head">
          <tr>
            ...
            <th
              ...
              v-permission="{
                action: ['can view warehouse update', 'can view warehouse delete']
              }"
            >
              Actions
            </th>
...
import AddWarehouse from '@src/components/warehouse/AddWarehouse.vue';
import EditWarehouse from '@src/components/warehouse/EditWarehouse.vue';
...
const moreOptions = ref([
  {
    ...
    permission: hasPermission(['can view warehouse update'])
  },
  {
    label: 'Delete',
    key: 'delete',
    icon: renderIcon(DeleteOutlined),
    permission: hasPermission(['can view warehouse delete'])
  }
]);
...
function deleteOperation() {
  ...
  deleteRecordApi('/warehouse/' + selectedId.value)
    .then((res: any) => {
