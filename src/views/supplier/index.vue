<template>
  <DataTableLayout :loading="loading" v-permission="{ action: ['can view supplier'] }">
      ...
      <div class="flex flex-col items-center space-y-2 sm:flex-row sm:justify-between sm:space-y-0">
        ...
        <div class="flex w-full items-center justify-between space-x-3 sm:justify-end">
          <NButton
            ...
            v-permission="{ action: ['can view supplier create'] }"
          >
            Create
          </NButton>
        </div>
...
const moreOptions = ref([
  {
    ...
    permission: hasPermission(['can view supplier update'])
  },
  {
    label: 'Delete',
    key: 'delete',
    icon: renderIcon(DeleteOutlined),
    permission: hasPermission(['can view supplier delete'])
  }
]);
