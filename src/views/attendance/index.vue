      ...
      <div class="flex w-full items-center px-10 pt-5">
        ...
        <div class="flex flex-1 w-full items-center justify-between space-x-3 sm:justify-end">
          <NButton
            ...
            v-permission="{ action: ['can view attendance create'] }"
          >
            Add Attendance
          </NButton>
        </div>
            ...
            <thead class="head">
              <tr>
                ...
                <th
                  ...
                  v-permission="{
                    action: ['can view attendance update', 'can view attendance delete']
                  }"
                >
                  Actions
                </th>
...
import AddAttendance from '@src/components/attendance/AddAttendance.vue';
import EditAttendance from '@src/components/attendance/EditAttendance.vue';
...
const moreOptions = ref([
  {
    ...
    permission: hasPermission(['can view attendance update'])
  },
  {
    label: 'Delete',
    key: 'delete',
    icon: renderIcon(DeleteOutlined),
    permission: hasPermission(['can view attendance delete'])
  }
]);
...
function deleteOperation() {
  ...
  deleteRecordApi(`/attendance/${selectedId.value}`)
    .then((res: any) => {
