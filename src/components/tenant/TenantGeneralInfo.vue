    ...
    <template #content>
      ...
      <div class="grid grid-cols-3 gap-5">
        ...
        <div class="w-full">
          ...
          <InputText id="domain_name" v-model.trim="data.domain_name" :required="true"
            :invalid="submitted && !data.domain_name" fluid placeholder="Domain Name" />
          <small v-if="submitted && !data.domain_name" class="text-red-500">Domain Name is required.</small>
        </div>
        <div class="w-full">
          <label for="email" class="block font-semibold mb-1">Email</label>
          <InputText id="email" v-model.trim="data.email" :required="true" :invalid="submitted && !data.email" fluid
            placeholder="Email" />
        ...
        <div class="w-full">
          ...
          <Select id="plan_id" v-model="data.plan_id" :options="plans" option-label="name" option-value="id"
